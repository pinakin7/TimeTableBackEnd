...
//        TODO Testing the code
        ...
        USER u = new USER();
        USER_MODEL ums = new USER_MODEL("vivek", "vivek03", "S");
...
//        STUDENT_MODEL sm = new STUDENT_MODEL("vivek", "Vivek");
...
//        f.SetFacultyID(fm);
//        
//        System.out.println(s.SetStudent(sm));
...
//           System.out.println(ENROLLMENTS.EnrollStudentCourse(em));
            ...
            Timestamp ts1 = new Timestamp(1500000);
